...
namespace AmazonBBS.DAL
{
    ...
    /// 工作评论
    /// </summary>
    public class Auto_JobCommentDAL
    {
		...
		{			
			string sql="delete from JobComment where JobCommentID=@JobCommentID";
			
			SqlParameter[] parameters = { new SqlParameter("@JobCommentID", Id) };			
        ...
        {
            string sql = "SELECT JobCommentID,MainID,CommentType,Comment,CreateHeadUrl,CreateNickName,CreateUser,CreateTime,IsDelete FROM JobComment WHERE JobCommentID=@JobCommentID";
			SqlParameter[] parameters = { new SqlParameter("@JobCommentID", Id) };
		...
		public int Count()
        {
            string sql="select count(*) from JobComment ";
        ...
        {
            string sql = "SELECT JobCommentID,MainID,CommentType,Comment,CreateHeadUrl,CreateNickName,CreateUser,CreateTime,IsDelete FROM JobComment ORDER BY JobCommentID desc ";
        ...
        {
            string sql = "SELECT top " + number + " JobCommentID,MainID,CommentType,Comment,CreateHeadUrl,CreateNickName,CreateUser,CreateTime,IsDelete FROM JobComment ORDER BY JobCommentID desc ";
            return SqlHelper.GetTable(sql);
        }	
        ...
        public DataTable Query(int pageIndex, int pageSize)
        {
            ...
            sb.Append(" select * from  (SELECT ROW_NUMBER() OVER(ORDER BY JobCommentID desc  ) as rowid ,JobCommentID,MainID,CommentType,Comment,CreateHeadUrl,CreateNickName,CreateUser,CreateTime,IsDelete FROM JobComment   ) ");
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.Append(" select * from  (SELECT ROW_NUMBER() OVER(ORDER BY JobCommentID desc  ) as rowid ,JobCommentID,CommentType,MainID,Comment,CreateHeadUrl,CreateNickName,CreateUser,CreateTime,IsDelete FROM JobComment   ) ");
