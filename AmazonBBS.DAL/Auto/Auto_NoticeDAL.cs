...
namespace AmazonBBS.DAL
{
    ...
    public class Auto_NoticeDAL
    {
        ...
        /// <returns></returns>
        public int Add(Notice model, SqlTransaction tran = null)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Notice(");
            strSql.Append(" NoticeTitle,NoticeContent,NoticeType,ToUserID,IsRead,ReadTime,CreateTime,IsDelete )");
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public bool Update(Notice model, SqlTransaction tran = null)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Notice set ");
            strSql.Append("NoticeTitle=@NoticeTitle,NoticeContent=@NoticeContent,NoticeType=@NoticeType,ToUserID=@ToUserID,IsRead=@IsRead,ReadTime=@ReadTime,CreateTime=@CreateTime,IsDelete=@IsDelete");
        ...
        public bool Delete(long Id)
        {
            ...
            SqlParameter[] parameters = { new SqlParameter("@NoticeId", Id) };
        ...
        {
            string sql = "SELECT NoticeId,NoticeTitle,NoticeContent,NoticeType,ToUserID,IsRead,ReadTime,CreateTime,IsDelete FROM Notice WHERE NoticeId=@NoticeId";
            SqlParameter[] parameters = { new SqlParameter("@NoticeId", Id) };
        ...
        {
            string sql = "SELECT NoticeId,NoticeTitle,NoticeContent,NoticeType,ToUserID,IsRead,ReadTime,CreateTime,IsDelete FROM Notice ORDER BY NoticeId desc ";
        ...
        {
            string sql = "SELECT top " + number + " NoticeId,NoticeTitle,NoticeContent,NoticeType,ToUserID,IsRead,ReadTime,CreateTime,IsDelete FROM Notice ORDER BY NoticeId desc ";
            return SqlHelper.GetTable(sql);
        }
        ...
        public DataTable Query(int pageIndex, int pageSize)
        {
            ...
            sb.Append(" select * from  (SELECT ROW_NUMBER() OVER(ORDER BY NoticeId desc  ) as rowid ,NoticeId,NoticeTitle,NoticeContent,NoticeType,ToUserID,IsRead,ReadTime,CreateTime,IsDelete FROM Notice   ) ");
