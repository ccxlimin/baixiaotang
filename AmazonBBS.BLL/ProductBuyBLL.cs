...
namespace AmazonBBS.BLL
{
    ...
    /// 产品预约购买记录
    /// </summary>
    public class ProductBuyBLL : Auto_ProductBuyBLL
    {
        public static ProductBuyBLL Instance
        {
            get { return SingleHepler<ProductBuyBLL>.Instance; }
        }
        ProductBuyDAL dal = new ProductBuyDAL();
        ...
        /// <param name="id">主键</param>
        /// <returns></returns>
        public ProductBuy GetModel<T>(T id)
        {
            return GetItem(id);
        }
        #endregion
        ...
        //
        //    List<ProductBuy> li = ModelConvertHelper<ProductBuy>.ConvertToList(tab);
        ...
        public Paging SearchByRows(int pageIndex)
        {
            ...
            if (paging.RecordCount > 0)
            {
                ...
                var li = ModelConvertHelper<ProductBuy>.ConvertToList(tab);
                //paging.SetDataSource(li);
            }
            return paging;
        }
