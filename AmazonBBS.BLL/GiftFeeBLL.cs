...
namespace AmazonBBS.BLL
{
    ...
    /// 礼物费用表
    /// </summary>
    public class GiftFeeBLL : Auto_GiftFeeBLL
    {
        public static GiftFeeBLL Instance
        {
            get { return SingleHepler<GiftFeeBLL>.Instance; }
        }
        GiftFeeDAL dal = new GiftFeeDAL();
        ...
        /// <returns></returns>
        public ResultInfo Create(GiftFee model, SqlTransaction tran = null)
        {
        ...
        /// <returns></returns>
        public ResultInfo Update(GiftFee model, SqlTransaction tran = null)
        {
            ResultInfo ri = new ResultInfo();
            if (Edit(model, tran))
            {
        ...
        /// <param name="id">主键</param>
        /// <returns></returns>
        public GiftFee GetModel<T>(T id)
        {
            return GetItem(id);
        }
        #endregion
        ...
        //
        //    List<GiftFee> li = ModelConvertHelper<GiftFee>.ConvertToList(tab);
        ...
        public Paging SearchByRows(int pageIndex)
        {
            ...
            if (paging.RecordCount > 0)
            {
                ...
                var li = ModelConvertHelper<GiftFee>.ConvertToList(tab);
                //paging.SetDataSource(li);
            }
            return paging;
        }
        ...
        {
            return dal.UpdateCount(buycount, giftfeeid, tran);
        }
        #endregion
    }
}
