...
namespace AmazonBBS.BLL
{
    ...
    /// 用户动态头像
    /// </summary>
    public class VIPHeadBLL : Auto_VIPHeadBLL
    {
        public static VIPHeadBLL Instance
        {
            get { return SingleHepler<VIPHeadBLL>.Instance; }
        }
        VIPHeadDAL dal = new VIPHeadDAL();
        ...
        /// <param name="id">主键</param>
        /// <returns></returns>
        public VIPHead GetModel<T>(T id)
        {
            return GetItem(id);
        }
        #endregion
        ...
        //
        //    List<VIPHead> li = ModelConvertHelper<VIPHead>.ConvertToList(tab);
        ...
        public Paging SearchByRows(int pageIndex)
        {
            ...
            if (paging.RecordCount > 0)
            {
                ...
                var li = ModelConvertHelper<VIPHead>.ConvertToList(tab);
                //paging.SetDataSource(li);
            }
            return paging;
        }

        public List<VIPHeadUrlViewModel> GetALLVIPHead()
        {
            return ModelConvertHelper<VIPHeadUrlViewModel>.ConvertToList(dal.GetALLVIPHead());
        }
        #endregion
    }
}
