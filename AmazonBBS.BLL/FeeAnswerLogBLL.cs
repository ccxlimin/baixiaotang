...
namespace AmazonBBS.BLL
{
    ...
    /// 消费查看答案记录表
    /// </summary>
    public class FeeAnswerLogBLL : Auto_FeeAnswerLogBLL
    {
        public static FeeAnswerLogBLL Instance
        {
            get { return SingleHepler<FeeAnswerLogBLL>.Instance; }
        }
        FeeAnswerLogDAL dal = new FeeAnswerLogDAL();
        ...
        /// <returns></returns>
        public ResultInfo Create(FeeAnswerLog model, SqlTransaction tran = null)
        {
        ...
        /// <returns></returns>
        public ResultInfo Update(FeeAnswerLog model)
        {
            ResultInfo ri = new ResultInfo();
            if (Edit(model))
            {
        ...
        /// <param name="id">主键</param>
        /// <returns></returns>
        public FeeAnswerLog GetModel(long id)
        {
            return GetItem(id);
        }
        #endregion
        ...
        //
        //    List<FeeAnswerLog> li = ModelConvertHelper<FeeAnswerLog>.ConvertToList(tab);
        ...
        public Paging SearchByRows(int pageIndex)
        {
            ...
            if (paging.RecordCount > 0)
            {
                ...
                var li = ModelConvertHelper<FeeAnswerLog>.ConvertToList(tab);
                //paging.SetDataSource(li);
            }
            return paging;
