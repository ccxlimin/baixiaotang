...
namespace AmazonBBS.BLL
{
    ...
    /// 邀请面试记录表
    /// </summary>
    public class InviteInterviewBLL : Auto_InviteInterviewBLL
    {
        public static InviteInterviewBLL Instance
        {
            get { return SingleHepler<InviteInterviewBLL>.Instance; }
        }
        InviteInterviewDAL dal = new InviteInterviewDAL();
        ...
        /// <param name="id">主键</param>
        /// <returns></returns>
        public InviteInterview GetModel<T>(T id)
        {
            return GetItem(id);
        }
        #endregion
        ...
        //
        //    List<InviteInterview> li = ModelConvertHelper<InviteInterview>.ConvertToList(tab);
        ...
        public Paging SearchByRows(int pageIndex)
        {
            ...
            if (paging.RecordCount > 0)
            {
                ...
                var li = ModelConvertHelper<InviteInterview>.ConvertToList(tab);
                //paging.SetDataSource(li);
            }
            return paging;
        }

        public bool Hasinvited(long qiuZhiID, long userID)
        {
            return dal.Hasinvited(qiuZhiID, userID).ToInt32() > 0;
        }
        #endregion
    }
}
