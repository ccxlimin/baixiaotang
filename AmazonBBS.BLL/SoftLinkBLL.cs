...
namespace AmazonBBS.BLL
{
    ...
    /// 软件导航
    /// </summary>
    public class SoftLinkBLL : Auto_SoftLinkBLL
    {
        public static SoftLinkBLL Instance
        {
            get { return SingleHepler<SoftLinkBLL>.Instance; }
        }
        SoftLinkDAL dal = new SoftLinkDAL();
        ...
        /// <param name="id">主键</param>
        /// <returns></returns>
        public SoftLink GetModel(long id)
        {
            return GetItem(id);
        }
        #endregion
        ...
        {
            dal.DeleteALLByID(softLinkTypeID);
        }
