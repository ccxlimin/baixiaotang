...
namespace AmazonBBS.BLL
{
    ...
    /// 公司新闻
    /// </summary>
    public class NewsBLL : Auto_NewsBLL
    {
        public static NewsBLL Instance
        {
            get { return SingleHepler<NewsBLL>.Instance; }
        }
        ...
        /// <returns></returns>
        public ResultInfo Create(News model)
        {
        ...
        /// <returns></returns>
        public ResultInfo Update(News model)
        {
            ResultInfo ri = new ResultInfo();
            if (Edit(model))
            {
        ...
        public List<News> FindList(int count)
        {
            DataTable dt = dal.Top5(count);
