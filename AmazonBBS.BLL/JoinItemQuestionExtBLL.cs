...
namespace AmazonBBS.BLL
{
    ...
    /// 报名购买选项问题扩展表
    /// </summary>
    public class JoinItemQuestionExtBLL : Auto_JoinItemQuestionExtBLL
    {
        public static JoinItemQuestionExtBLL Instance
        {
            get { return SingleHepler<JoinItemQuestionExtBLL>.Instance; }
        }
        JoinItemQuestionExtDAL dal = new JoinItemQuestionExtDAL();
        ...
        /// <param name="id">主键</param>
        /// <returns></returns>
        public JoinItemQuestionExt GetModel<T>(T id)
        {
            return GetItem(id);
        }
        #endregion
        ...
        //
        //    List<JoinItemQuestionExt> li = ModelConvertHelper<JoinItemQuestionExt>.ConvertToList(tab);
        ...
        public Paging SearchByRows(int pageIndex)
        {
            ...
            if (paging.RecordCount > 0)
            {
                ...
                var li = ModelConvertHelper<JoinItemQuestionExt>.ConvertToList(tab);
                //paging.SetDataSource(li);
            }
            return paging;
        }
