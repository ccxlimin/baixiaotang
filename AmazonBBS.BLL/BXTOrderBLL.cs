...
namespace AmazonBBS.BLL
{
    ...
    /// 订单
    /// </summary>
    public class BXTOrderBLL : Auto_BXTOrderBLL
    {
        public static BXTOrderBLL Instance
        {
            get { return SingleHepler<BXTOrderBLL>.Instance; }
        }
        BXTOrderDAL dal = new BXTOrderDAL();
        ...
        /// <param name="id">主键</param>
        /// <returns></returns>
        public BXTOrder GetModel(long id)
        {
            return GetItem(id);
        }
        #endregion
        ...
        //
        //    List<BXTOrder> li = ModelConvertHelper<BXTOrder>.ConvertToList(tab);
        ...
        public Paging SearchByRows(int pageIndex)
        {
            ...
            if (paging.RecordCount > 0)
            {
                ...
                var li = ModelConvertHelper<BXTOrder>.ConvertToList(tab);
                //paging.SetDataSource(li);
            }
            return paging;
