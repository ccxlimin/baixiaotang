...
namespace AmazonBBS.BLL
{
    ...
    /// 
    /// </summary>
    public class LeaveWordBLL : Auto_LeaveWordBLL
    {
        public static LeaveWordBLL Instance
        {
            get { return SingleHepler<LeaveWordBLL>.Instance; }
        }
        LeaveWordDAL dal = new LeaveWordDAL();
        ...
        /// <param name="id">主键</param>
        /// <returns></returns>
        public LeaveWord GetModel(long id)
        {
            return GetItem(id);
        }
        #endregion
        ...
        //
        //    List<LeaveWord> li = ModelConvertHelper<LeaveWord>.ConvertToList(tab);
        ...
        public Paging SearchByRows(int pageIndex)
        {
            ...
            if (paging.RecordCount > 0)
            {
                ...
                var li = ModelConvertHelper<LeaveWord>.ConvertToList(tab);
                //paging.SetDataSource(li);
            }
            return paging;
