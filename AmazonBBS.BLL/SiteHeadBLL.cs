...
namespace AmazonBBS.BLL
{
    ...
    /// 网站系统头像
    /// </summary>
    public class SiteHeadBLL : Auto_SiteHeadBLL
    {
        public static SiteHeadBLL Instance
        {
            get { return SingleHepler<SiteHeadBLL>.Instance; }
        }
        SiteHeadDAL dal = new SiteHeadDAL();
        ...
        /// <returns></returns>
        public ResultInfo Create(SiteHead model, SqlTransaction tran = null)
        {
        ...
        /// <returns></returns>
        public ResultInfo Update(SiteHead model, SqlTransaction tran = null)
        {
            ResultInfo ri = new ResultInfo();
            if (Edit(model, tran))
            {
        ...
        /// <param name="id">主键</param>
        /// <returns></returns>
        public SiteHead GetModel(long id)
        {
            return GetItem(id);
        }
        #endregion
        ...
        //
        //    List<SiteHead> li = ModelConvertHelper<SiteHead>.ConvertToList(tab);
        ...
        public Paging SearchByRows(int pageIndex)
        {
            ...
            if (paging.RecordCount > 0)
            {
                ...
                var li = ModelConvertHelper<SiteHead>.ConvertToList(tab);
                //paging.SetDataSource(li);
            }
            return paging;
        }
