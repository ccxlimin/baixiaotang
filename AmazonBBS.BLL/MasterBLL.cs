...
namespace AmazonBBS.BLL
{
    ...
    /// 管理员表
    /// </summary>
    public class MasterBLL : Auto_MasterBLL
    {
        public static MasterBLL Instance
        {
            get { return SingleHepler<MasterBLL>.Instance; }
        }
        ...
        /// <returns></returns>
        public ResultInfo Create(Master model)
        {
        ...
        /// <returns></returns>
        public ResultInfo Update(Master model)
        {
            ResultInfo ri = new ResultInfo();
            if (Edit(model))
            {
        ...
        /// <param name="id">主键</param>
        /// <returns></returns>
        public Master GetModel(long id)
        {
            return GetItem(id);
        }
        #endregion
        ...
        //
        //    List<Master> li = ModelConvertHelper<Master>.ConvertToList(tab);
        ...
        public Paging SearchByRows(int pageIndex)
        {
            ...
            if (paging.RecordCount > 0)
            {
                ...
                var li = ModelConvertHelper<Master>.ConvertToList(tab);
                //paging.SetDataSource(li);
            }
            return paging;
        ...
        public List<MasterViewModel> GetAllMaster()
        {
            return ModelConvertHelper<MasterViewModel>.ConvertToList(dal.GetAllMaster());
        }
    }
}
