...
namespace AmazonBBS.BLL
{
    ...
    /// 评论表
    /// </summary>
    public class Auto_CommentBLL
    {
        Auto_CommentDAL dal = new Auto_CommentDAL();
        ...
        public Comment GetItem(long id)
        {
            ...
            return ModelConvertHelper<Comment>.ConvertToList(dt).FirstOrDefault();
        }
        #endregion
        ...
        public List<Comment> SearchAll()
        {
            ...
            return ModelConvertHelper<Comment>.ConvertToList(dt);
        }
        ...
        /// <returns></returns>
        public List<Comment> SearchAll(int top)
        {
        ...
        /// <returns></returns>      
        public List<Comment> SearchByRows(int startIndex, int endIndex)
        {
