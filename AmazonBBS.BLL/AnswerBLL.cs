...
namespace AmazonBBS.BLL
{
    ...
    /// 回答表
    /// </summary>
    public class AnswerBLL : Auto_AnswerBLL
    {
        public static AnswerBLL Instance
        {
            get { return SingleHepler<AnswerBLL>.Instance; }
        }
        ...
        /// <returns></returns>
        public ResultInfo Create(Answer model)
        {
        ...
        /// <returns></returns>
        public ResultInfo Update(Answer model)
        {
            ResultInfo ri = new ResultInfo();
            if (Edit(model))
            {
        ...
        /// <param name="id">主键</param>
        /// <returns></returns>
        public Answer GetModel(long id)
        {
            return GetItem(id);
        }
        #endregion
        ...
        //
        //    List<Answer> li = ModelConvertHelper<Answer>.ConvertToList(tab);
        ...
        public Paging SearchByRows(int pageIndex)
        {
            ...
            if (paging.RecordCount > 0)
            {
                ...
                var li = ModelConvertHelper<Answer>.ConvertToList(tab);
                //paging.SetDataSource(li);
            }
            return paging;
