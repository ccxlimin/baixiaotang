...
namespace AmazonBBS.BLL
{
    ...
    /// 支付回调日志
    /// </summary>
    public class PayCBLogBLL : Auto_PayCBLogBLL
    {
        public static PayCBLogBLL Instance
        {
            get { return SingleHepler<PayCBLogBLL>.Instance; }
        }
        PayCBLogDAL dal = new PayCBLogDAL();
        ...
        /// <param name="id">主键</param>
        /// <returns></returns>
        public PayCBLog GetModel(long id)
        {
            return GetItem(id);
        }
        #endregion
        ...
        //
        //    List<PayCBLog> li = ModelConvertHelper<PayCBLog>.ConvertToList(tab);
        ...
        public Paging SearchByRows(int pageIndex)
        {
            ...
            if (paging.RecordCount > 0)
            {
                ...
                var li = ModelConvertHelper<PayCBLog>.ConvertToList(tab);
                //paging.SetDataSource(li);
            }
            return paging;
