...
namespace AmazonBBS.BLL
{
    ...
    /// 推荐网站
    /// </summary>
    public class SuggestSiteBLL : Auto_SuggestSiteBLL
    {
        public static SuggestSiteBLL Instance
        {
            get { return SingleHepler<SuggestSiteBLL>.Instance; }
        }
        SuggestSiteDAL dal = new SuggestSiteDAL();
        ...
        /// <returns></returns>
        public ResultInfo Create(SuggestSite model)
        {
        ...
        /// <returns></returns>
        public ResultInfo Update(SuggestSite model)
        {
            ResultInfo ri = new ResultInfo();
            if (Edit(model))
            {
        ...
        /// <param name="id">主键</param>
        /// <returns></returns>
        public SuggestSite GetModel(long id)
        {
            return GetItem(id);
        }
        #endregion
        ...
        //
        //    List<SuggestSite> li = ModelConvertHelper<SuggestSite>.ConvertToList(tab);
        ...
        public Paging SearchByRows(int pageIndex)
        {
            ...
            if (paging.RecordCount > 0)
            {
                ...
                var li = ModelConvertHelper<SuggestSite>.ConvertToList(tab);
                //paging.SetDataSource(li);
            }
            return paging;
        }
