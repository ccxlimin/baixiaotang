...
namespace AmazonBBS.BLL
{
    ...
    /// 邮件通知
    /// </summary>
    public class EmailNoticeBLL : Auto_EmailNoticeBLL
    {
        public static EmailNoticeBLL Instance
        {
            get { return SingleHepler<EmailNoticeBLL>.Instance; }
        }
        EmailNoticeDAL dal = new EmailNoticeDAL();
        ...
        /// <param name="id">主键</param>
        /// <returns></returns>
        public EmailNotice GetModel(long id)
        {
            return GetItem(id);
        }
        #endregion
        ...
        //
        //    List<EmailNotice> li = ModelConvertHelper<EmailNotice>.ConvertToList(tab);
        ...
        public Paging SearchByRows(int pageIndex)
        {
            ...
            if (paging.RecordCount > 0)
            {
                ...
                var li = ModelConvertHelper<EmailNotice>.ConvertToList(tab);
                //paging.SetDataSource(li);
            }
            return paging;
        }
