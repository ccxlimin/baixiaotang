...
namespace AmazonBBS.BLL
{
    ...
    /// 用户积分表
    /// </summary>
    public class UserScoreBLL : Auto_UserScoreBLL
    {
        public static UserScoreBLL Instance
        {
            get { return SingleHepler<UserScoreBLL>.Instance; }
        }
        UserScoreDAL dal = new UserScoreDAL();
        ...
        /// <returns></returns>
        public ResultInfo Create(UserScore model)
        {
        ...
        /// <returns></returns>
        public ResultInfo Update(UserScore model)
        {
            ResultInfo ri = new ResultInfo();
            if (Edit(model))
            {
        ...
        /// <param name="id">主键</param>
        /// <returns></returns>
        public UserScore GetModel(long id)
        {
            return GetItem(id);
        }
        #endregion
        ...
        //
        //    List<UserScore> li = ModelConvertHelper<UserScore>.ConvertToList(tab);
        ...
        public Paging SearchByRows(int pageIndex)
        {
            ...
            if (paging.RecordCount > 0)
            {
                ...
                var li = ModelConvertHelper<UserScore>.ConvertToList(tab);
                //paging.SetDataSource(li);
            }
            return paging;
